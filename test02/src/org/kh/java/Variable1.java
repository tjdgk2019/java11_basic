...
public class Variable1 {
	public static void main(String[] args) {
		...
		//byte b = 255;	 //-128~127 ->해당 공간보다 큰 숫자이므로 Overflow
		//byte b = -129;	//해당 공간에 정장할 수 있는 숫자보다 더 작은 숫자이므로 Underflow
		...
		double h = 3.14;	//8byte
		System.out.println("byte : "+Byte.MIN_VALUE+"~"+Byte.MAX_VALUE); //파란색 글씨는 상수
